...
class script(object):
    START_TXT = """<quote><i>ʜᴇ'ʟʟᴏ {}, ᴍʏ ᴍʏsᴇʟғ <a href=https://t.me/{}>{}</a></i></quote>
      <b><i>// ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ғɪʟᴛᴇʀ ɪ ᴄᴀɴ sʜᴀʀᴇ ᴄᴀᴍʀɪᴘ ᴀɴᴅ ᴘʀᴇᴅᴠᴅ - ᴍᴏᴠɪᴇs // ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ 🪄</i></b>\n\n<b><i>ʜᴅʀɪᴘs ᴍᴏᴠɪᴇs // sᴇʀɪᴇs  >> <a href="t.me/PIFSearchRobot">ʙᴏᴛ ʟɪɴᴋ 🍁</a></i></b>"""
