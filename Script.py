...
class script(object):
    START_TXT = """<b><i>ʜᴇ'ʟʟᴏ {}, ᴍʏ ᴍʏsᴇʟғ <a href=https://t.me/{}>{}</a>
      //  ɪ ᴀᴍ ᴘᴏᴡᴇʀғᴜʟ ғɪʟᴛᴇʀ ɪ ᴄᴀɴ sʜᴀʀᴇ ᴄᴀᴍʀɪᴘ // ᴘʀᴇᴅᴠᴅ - ᴍᴏᴠɪᴇs ɪɴ ᴛᴇʟᴜɢᴜ | ᴛᴀᴍɪʟ | ʜɪɴᴅɪ  | ᴍᴀʟᴀʏᴀʟᴀᴍ | ᴋᴀɴɴᴀᴅᴀ // ᴀᴅᴅ ᴍᴇ ɪɴ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴛᴏ sᴇᴇ ᴛʜᴇ ᴍᴀɢɪᴄ 🪄</i></b>\n\n<b><i>ᴄᴀᴍʀɪᴘ // ᴘʀᴇᴅᴠᴅ - ᴍᴏᴠɪᴇs >> @PanindiaFilmz_bot</i></b>"""
